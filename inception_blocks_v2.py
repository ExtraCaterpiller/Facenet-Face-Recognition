import numpy as np
import os
from tensorflow.keras.layers import Conv2D, MaxPooling2D, AveragePooling2D, Activation, concatenate, ZeroPadding2D, BatchNormalization
...
def inception_block_1a(X):
    ...
    X_pool = ZeroPadding2D(padding=((1, 1), (1, 1)), data_format='channels_last')(X_pool)
...
def inception_block_1b(X):
    ...
    X_pool = AveragePooling2D(pool_size=(3, 3), strides=(1, 1), data_format='channels_last')(X)
